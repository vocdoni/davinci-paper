...
\noi Pieces of text marked in \textbf{blue} are heavily work in progress. Additionally, there are these general tasks left:
...
\begin{itemize}
	...
	\item Consider the scenario with deterministic signature (no Eth compatible) that can be used as nullifier.
